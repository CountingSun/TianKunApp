...
#import "HomeConstructionTListableViewCell.h"
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    HomeConstructionTListableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"HomeConstructionTListableViewCell" owner:nil options:nil] firstObject];
        
    }
    CompanyInfo *companyInfo = _arrData[indexPath.section];
    cell.nameLabel.text = companyInfo.companyName;
    cell.entityLabel.text = companyInfo.companyLegalRepresentative;
    cell.addressLabel.text = companyInfo.registered_address;
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    static NSString *viewID = @"identifier";
