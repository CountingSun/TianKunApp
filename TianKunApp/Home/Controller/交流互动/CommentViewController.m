...
@interface CommentViewController ()<QMUIKeyboardManagerDelegate>
...
- (void)viewDidLayoutSubviews {
    ...
    CGRect containerRect = CGRectFlatMake(0, CGRectGetHeight(self.view.bounds), CGRectGetWidth(self.view.bounds), 150);
