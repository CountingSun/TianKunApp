...
- (void)getRecommend{
    ...
    [_eductationNetworkEngine postWithPageIndex:_pageIndex pageSize:_pageSize dataType2:-1 calssType:-1 docID:0 returnBlock:^(NSInteger code,NSString *msg, NSMutableArray *arrData) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (info.is_charge) {
        cell.isFreeLabel.text = [NSString stringWithFormat:@"￥%@",@(info.money)];
    }else{
