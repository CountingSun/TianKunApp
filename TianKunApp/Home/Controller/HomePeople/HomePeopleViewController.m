...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    HomePeopleListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"HomePeopleListTableViewCell" owner:nil options:nil] firstObject];
        
    }
    PeopleInfo *info = _arrData[indexPath.section];
    cell.nameLabel.text = info.name;
    cell.idCardLabel.text = info.certificate_number;
    cell.registerClassLabel.text = info.category_id;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    HomePeopleInfoViewController *vc = [[HomePeopleInfoViewController alloc]initWithPeopleID:[info.people_id integerValue]];
