...
- (void)searchEvent{
    FileSearchViewController *vc = [[FileSearchViewController alloc] initWithFromType:FileSearchTypeNotice];
...
- (void)getData{
    ...
    [self.netWorkEngine postWithDict:dict url:BaseUrl(@"ArticleNotices/findarticlenoticefenyebyid.action") succed:^(id responseObject) {
