...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (info.want_salary_end<=0) {
        cell.infoLabel.text = [NSString stringWithFormat:@"面议  %@ %@ %@",sexString,info.workplace_number_string,info.work_type_string];
