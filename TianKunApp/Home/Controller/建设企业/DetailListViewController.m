...
- (void)setAptitudeInfo:(AptitudeInfo *)aptitudeInfo{
    ...
    [self.arrData addObject:info3];
    MenuInfo *info4 = [[MenuInfo alloc] initWithMenuName:@"发证日期：" menuIcon:@"" menuID:0 menuDetail:aptitudeInfo.fzdate];
    [self.arrData addObject:info4];
    MenuInfo *info5 = [[MenuInfo alloc] initWithMenuName:@"证书有效日期：" menuIcon:@"" menuID:0 menuDetail:aptitudeInfo.jzdate];
    [self.arrData addObject:info5];
...
- (void)setSpecialBehaviorInfo:(SpecialBehaviorInfo *)specialBehaviorInfo{
    ...
    [self.arrData addObject:info4];
    MenuInfo *info5 = [[MenuInfo alloc] initWithMenuName:@"发布有效期：" menuIcon:@"" menuID:0 menuDetail:specialBehaviorInfo.expiration_date];
    [self.arrData addObject:info5];
    [ self.tableView reloadData];
...
- (void)setBlackListInfo:(BlackListInfo *)blackListInfo{
    ...
    [self.arrData addObject:info3];
    MenuInfo *info4 = [[MenuInfo alloc] initWithMenuName:@"列入黑名单日期：" menuIcon:@"" menuID:0 menuDetail:blackListInfo.start_time];
    [self.arrData addObject:info4];
    MenuInfo *info5 = [[MenuInfo alloc] initWithMenuName:@"移出黑名单日期：" menuIcon:@"" menuID:0 menuDetail:blackListInfo.end_time];
    [self.arrData addObject:info5];
    [ self.tableView reloadData];
...
- (void)setChangeInfo:(ChangeInfo *)changeInfo{
    ...
    MenuInfo *info2 = [[MenuInfo alloc] initWithMenuName:@"变更日期：" menuIcon:@"" menuID:0 menuDetail:changeInfo.change_date];
    [self.arrData addObject:info2];
