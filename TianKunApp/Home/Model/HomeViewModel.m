...
+ (NSMutableArray *)arrMenu{
        ...
        MenuInfo *menuInfo0 = [[MenuInfo alloc]initWithMenuName:@"行业资讯" menuIcon:@"行业资讯" menuID:0];
        [arrMenu addObject:menuInfo0];
        MenuInfo *menuInfo1 = [[MenuInfo alloc]initWithMenuName:@"薪资计算" menuIcon:@"薪资计算" menuID:1];
        ...
        MenuInfo *menuInfo4 = [[MenuInfo alloc]initWithMenuName:@"招标" menuIcon:@"招标信息" menuID:4];
        [arrMenu addObject:menuInfo4];
        MenuInfo *menuInfo5 = [[MenuInfo alloc]initWithMenuName:@"中标" menuIcon:@"中标信息" menuID:5];
        [arrMenu addObject:menuInfo5];
        MenuInfo *menuInfo6 = [[MenuInfo alloc]initWithMenuName:@"找人才" menuIcon:@"企业招聘" menuID:6];
        [arrMenu addObject:menuInfo6];
        MenuInfo *menuInfo7 = [[MenuInfo alloc]initWithMenuName:@"找工作" menuIcon:@"人才求职" menuID:7];
        ...
        MenuInfo *menuInfo9 = [[MenuInfo alloc]initWithMenuName:@"培训" menuIcon:@"教育培训" menuID:9];
