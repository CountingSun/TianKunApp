...
- (void)photoLibaryAuthorizationValid {
    ...
    if (authoriation == PHAuthorizationStatusNotDetermined) {
        ...
        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"不能预览图片" message:@"应用程序无访问照片权限, 请在“设置\"-\"隐私\"-\"照片”中设置允许访问" preferredStyle:UIAlertControllerStyleAlert];
...
- (void)cameraAuthoriationValidWithHandle:(void(^)(void))handle {
    ...
    if (authoriation == AVAuthorizationStatusNotDetermined) {
        ...
        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"应用程序无访问相机权限" message:@"请在“设置\"-\"隐私\"-\"相机”中设置允许访问" preferredStyle:UIAlertControllerStyleAlert];
