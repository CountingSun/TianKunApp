...
#define ChineseFestival @[@"除夕",@"春节",@"中秋节",@"五一",@"国庆节",@"儿童节",@"圣诞节",@"七夕",@"端午节"]
...
- (NSString *)getChineseCalendar{
    NSString *chineseCalendarString = @"";
    ...
    NSDateComponents *Datecomponents = [normalDate components:NSCalendarUnitYear | NSCalendarUnitMonth | NSCalendarUnitDay fromDate:self];
    
    chineseCalendarString = [NSString stringWithFormat:@"%@%@",ChineseMonths[components.month - 1],ChineseDays[components.day - 1]];
    //农历节日
    
    if (components.day ==1 && components.month ==1) {
        chineseCalendarString = [NSString stringWithFormat:@"%@",ChineseFestival[1]]; //春节
    } if(components.month ==8 && components.day == 15){
        chineseCalendarString = [NSString stringWithFormat:@"%@",ChineseFestival[2]];//中秋
    }else if(components.day == 1 && components.month == 1){
        chineseCalendarString = [NSString stringWithFormat:@"%@",ChineseFestival[0]];//除夕
    }else if(components.month == 7 && components.day == 7){
        chineseCalendarString = [NSString stringWithFormat:@"%@",ChineseFestival[7]];//七夕
    }else if(components.month == 5 && components.day == 5){
        chineseCalendarString = [NSString stringWithFormat:@"%@",ChineseFestival[8]];//端午
    }
    //阳历节日
    if (Datecomponents.month ==6 && Datecomponents.day ==1) {       //儿童节
        chineseCalendarString = [NSString stringWithFormat:@"%@",ChineseFestival[5]];
    }else if(Datecomponents.month ==10 && Datecomponents.day ==1){  //国庆节
        chineseCalendarString = [NSString stringWithFormat:@"%@",ChineseFestival[4]];
    }else if(Datecomponents.month ==5 && Datecomponents.day ==1){   //劳动节
        chineseCalendarString = [NSString stringWithFormat:@"%@",ChineseFestival[3]];
    }else if(Datecomponents.month ==12 && Datecomponents.day ==25){ //圣诞节
        chineseCalendarString = [NSString stringWithFormat:@"%@",ChineseFestival[6]];
    }
    
    
   NSString *string =  [self getLunarSpecialDate:Datecomponents.year Month:Datecomponents.month Day:Datecomponents.day];
    if (string.length) {
        chineseCalendarString = string;
    }
...
-(NSString *)getLunarSpecialDate:(NSInteger)iYear Month:(NSInteger)iMonth  Day:(NSInteger)iDay  {
    ...
    if ( index >=0  && index < [chineseDays count] ) {
        ...
        solarTermsString = chineseDays[index];
        return solarTermsString;
