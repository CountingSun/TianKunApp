...
//        nameLabel.text = @"精选";
//        nameLabel.frame = CGRectMake(labelX, labelY+2.5, 40, self.frame.size.height-5);
//        nameLabel.textColor = COLOR_THEME;
//        nameLabel.layer.borderWidth = 1;
//        nameLabel.layer.cornerRadius = 5;
//        nameLabel.layer.borderColor = COLOR_THEME.CGColor;
//        nameLabel.font = [UIFont systemFontOfSize:14];
//        nameLabel.tag = 200;
//
//        [self.ccpScrollView addSubview:nameLabel];
        ...
        titleLabel.frame = CGRectMake(10, labelY, self.frame.size.width-20, self.frame.size.height);
