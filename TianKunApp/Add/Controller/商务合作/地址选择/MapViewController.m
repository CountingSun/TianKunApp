...
- (void)didFailToLocateUserWithError:(NSError *)error{
    QMUIAlertController *alertController = [[QMUIAlertController alloc]initWithTitle:@"提示" message:@"定位失败,请到设置内允许APP访问您的位置信息" preferredStyle:QMUIAlertControllerStyleAlert];
